...
<head>
    ...
    <title>شركة الملمس الراقي للتجارة  | Almalmas Alraqi</title>
...
<body>
   ...
   <!-- <h1>عذرا الصفحة غير متاحة</h1>-->
          <!-- الشعار -->
        <img src="image/almalmas_alraqi.png" alt="شعار اللمس الراقي" class="logo" />

        <!-- اسم الحساب والوصف -->
        <h1>شركة الملمس الراقي للتجارة </h1>
        <p class="desc">✨ شركة رائدة تضم علامات تجارية مميزة✨</p>
        <p class="desc"> منظفات، معطرات، عناية بالطفل، وجمال المرأة </p>
        <p class="desc"> جودة مضمونة وأسعار تنافسية </p>
